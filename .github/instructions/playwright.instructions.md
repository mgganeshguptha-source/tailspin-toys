...
- **Clarity**: Use descriptive test and step titles that clearly state the intent. Comments should explain why a complex interaction is needed, not restate the test steps.
